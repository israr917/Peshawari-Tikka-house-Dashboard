		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#addSupplierModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add Supplier</span></a>
						<a href="#deleteSupplierModal" data-toggle="modal"> <span></span></a>						
					</div>
				</div>
			</div>
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<a href="#deleteSupplierModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
					</tr>
					<tr>
						<td>
